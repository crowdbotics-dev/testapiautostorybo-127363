...
## Project Structure
    ...
    ├── testapiautostorybo_127363  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_127363`
...
2. Clone this repo and `cd testapiautostorybo_127363`
